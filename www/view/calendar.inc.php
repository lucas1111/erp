...
class Calendar
{
    ...
    private function showChangeDate()
    {
        ...
        echo '<tr>';
    echo '<td><a href="/?action=management&'.$this->preYearUrl($this->year,$this->month).'">'.'<<'.'</a></td>';
    echo '<td><a href="/?action=management&'.$this->preMonthUrl($this->year,$this->month).'">'.'<'.'</a></td>';
        ...
        echo '</select>';       
        echo '</form></td>';       
    echo '<td><a href="/?action=management&'.$this->nextMonthUrl($this->year,$this->month).'">'.'>'.'</a></td>';
    echo '<td><a href="/?action=management&'.$this->nextYearUrl($this->year,$this->month).'">'.'>>'.'</a></td>';       
        echo '</tr>';
    }
